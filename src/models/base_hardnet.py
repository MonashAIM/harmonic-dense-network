...
class HarDNet(nn.Module):
    def __init__(self, depth_wise=False, arch=85, out_channels=1000):
        super().__init__()
        first_ch = [32, 64]
        second_kernel = 3
        max_pool = True
        ...
        self.base.append(
            ConvLayer(
                in_channels=1, out_channels=first_ch[0], kernel=3, stride=2, bias=False
            )
        )
